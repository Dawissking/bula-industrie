        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          {sectors.map((sector, index) => (
            <AnimatedSection key={sector.title} delay={index * 0.1}>
              <div className="group relative bg-white border border-gray-200 rounded-2xl p-5 sm:p-6 h-full transition-all duration-400 hover:-translate-y-1 sm:hover:-translate-y-2 hover:border-gold hover:shadow-[0_20px_60px_rgba(0,0,0,0.08),0_0_30px_rgba(212,160,23,0.1)]">
